    ...
    */
                    ...
                    if (supportedExtensionsTmp != null) {
                        ...
                        for (String extension : supportedExtensionsTmp) {
                            if (nameSelectedFile.endsWith(extension)) {
                                ...
                                showMessageDialog("Extensão " + extension + " aberta pelo plugin " + plugin.getClass().getSimpleName());                                
    ...
    public void setEditor(Editor editor) {
     ...
     public void setToolbox(IToolbox toolbox) {
        /**
         * Montar os componentes pode ser responsabilidade do UIController
         * retornar uma lista de objetos e deixar o UIControllser montar esses objetos no menu.
         * ex: List<JComponent> toolbox.getComponents();
        */ 
         toolbox.initialize();
    }
